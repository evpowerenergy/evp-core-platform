...
const LeadManagement = () => {
  ...
  // ✅ Enable optimized realtime updates for this user
  const { isConnected, subscriberCount, manualRefresh: refreshRealtime } = useRealtimeUpdates(user?.id);
  ...
  // Preload sales team data to ensure it's available for the table
  useEffect(() => {
    if (salesTeam.length > 0) {
      // Sales team data is loaded, no additional action needed
    }
  }, [salesTeam]);
  ...
  const statsWithContact = {
    ...stats,
    totalLeads: calculateLeadsByPlatformWithContact(filteredLeads, 'all', true),
  ...
  return (
    <div className="space-y-8 p-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">จัดการลีด Package</h1>
          <p className="text-gray-600 mb-1">ภาพรวมการจัดการลีดและการขายโซลูชันพลังงานสะอาด</p>
      ...
      {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <PlatformChart platformData={platformData} />
      </div> */}
