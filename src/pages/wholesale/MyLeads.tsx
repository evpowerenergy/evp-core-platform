...
const WholesaleMyLeads = () => {
  ...
  const { data: myLeadsData, isLoading: myLeadsLoading, refetch: refetchMyLeads } = useMyLeadsData('Wholesales');
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            ลีด Wholesale ของ {salesMember?.name || 'ฉัน'}
          </h1>
          <p className="text-gray-600 mb-1">จัดการลีด Wholesale ที่รับผิดชอบ ({myLeads.length} รายการ)</p>
...
export default WholesaleMyLeads;
