...
import { Calendar, CalendarDays, Clock, User, Package, RefreshCw } from "lucide-react";
...
const WholesaleMyAppointments = () => {
  ...
  const { data: myLeadsData, isLoading: myLeadsLoading } = useMyLeadsData('Wholesale');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      {/* Enhanced Tabbed Calendar Sections with Integrated Header for Wholesale - Full Width */}
      <div className="bg-white shadow-xl border-b-2 border-gray-100">
        <Tabs defaultValue="follow-up" className="w-full">
          {/* Integrated Header with Tabs for Wholesale */}
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-b-2 border-purple-100">
            <div className="px-8 py-6 pb-0">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-gray-900">ตารางนัดหมาย Wholesale</h1>
                    <p className="text-gray-600 mb-1">จัดการและติดตามนัดหมายสำหรับลูกค้า Wholesale</p>
            ...
            <TabsList className="grid w-full grid-cols-3 h-16 bg-white/80 backdrop-blur-sm rounded-none border-b-2 border-purple-100 mx-8 mb-0">
              <TabsTrigger 
                value="follow-up" 
                className="flex items-center gap-3 text-base font-semibold h-full data-[state=active]:bg-purple-50 data-[state=active]:text-purple-700 data-[state=active]:border-b-2 data-[state=active]:border-purple-500"
              >
          ...
          <div className="px-8 py-8">
            <TabsContent value="follow-up" className="mt-0">
              <AppointmentCalendarSection
                ...
                title="นัดติดตามครั้งถัดไป (Wholesale)"
            ...
            <TabsContent value="payment" className="mt-0">
              <AppointmentCalendarSection
                ...
                title="ประมาณการชำระเงิน (Wholesale)"
...
export default WholesaleMyAppointments;
